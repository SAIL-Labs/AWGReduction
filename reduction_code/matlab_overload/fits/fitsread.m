function [data, header]= fitsread(varargin)
% cbetters overide
...
%   $Revision: 1.1.6.26.2.1 $  $Date: 2012/06/22 15:26:41 $
...
if index > numel(offsets)
    error(message('MATLAB:imagesci:fitsread:extensionNumberImage',index));
end
